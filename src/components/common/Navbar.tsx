...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  const isMoreActive = currentView === 'history';
          ...
          <nav className="hidden lg:flex items-center gap-1">
            ...
            <div className="relative" ref={moreDropdownRef}>
              <button
                ...
                title="Additional features and tools"
              >
                <Menu className="w-4 h-4 text-slate-500" />
                <span>More</span>
                <ChevronDown className={`w-3.5 h-3.5 transition-transform duration-200 ${isDesktopMoreOpen ? 'rotate-180' : ''}`} />
              </button>
              ...
              {isDesktopMoreOpen && (
                <div className="absolute right-0 mt-2 w-64 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-2xl py-2 z-50 animate-in fade-in zoom-in-95 duration-150">
                  <div className="px-3.5 py-1.5 text-[10px] font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500">
                    Additional Options
                  </div>
                  ...
                  <button
                    ...
                    className={`w-full flex items-center gap-3 px-3.5 py-2.5 text-xs font-semibold text-left transition ${
                      currentView === 'history'
                        ? 'bg-indigo-50 text-indigo-700 dark:bg-indigo-950/70 dark:text-indigo-300'
                  ...
                  >
                    ...
                    <div>
                      <span className="block font-bold">Past Attempts</span>
                      <span className="text-[11px] text-slate-400 font-normal">Score history &amp; speed analytics</span>
                    </div>
                  </button>
                  ...
                  <button
                    ...
                    className="w-full flex items-center gap-3 px-3.5 py-2.5 text-xs font-semibold text-left text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 transition"
                  >
                    <div className="p-2 rounded-xl bg-emerald-50 dark:bg-emerald-950/60 text-emerald-600 dark:text-emerald-400">
                      <FilePlus className="w-4 h-4" />
                    </div>
                    <div>
                      <span className="block font-bold">Generate Exam</span>
                      <span className="text-[11px] text-slate-400 font-normal">AI mock or PDF/OCR upload</span>
                    </div>
                  </button>
                </div>
              )}
