...
export const EXAM_CONFIGS: ExamPatternConfig[] = [
  {
    ...
    totalQuestions: 100,
    marksPerQuestion: 1,
    negativeMarkRatio: 0.333, // 1/3rd negative marking
  ...
  },
  {
    ...
    totalQuestions: 100,
    marksPerQuestion: 2,
    negativeMarkRatio: 0.25, // 0.50 marks deducted per wrong answer (1/4th)
  ...
  },
  {
    ...
    totalQuestions: 100,
    marksPerQuestion: 1,
    negativeMarkRatio: 0.25, // 0.25 marks deducted per wrong answer
  ...
  {
    id: 'wbpsc_clerkship',
    name: 'WBPSC Clerkship / WBCS Prelims',
    shortName: 'WBPSC Clerkship',
    description: 'West Bengal Public Service Commission Exam covering History of Bengal, Indian National Movement, Geography of WB, Arithmetic, and English.',
    tierOrStage: 'Part 1 / Prelims',
    durationMinutes: 90,
    totalQuestions: 100,
    marksPerQuestion: 1,
    negativeMarkRatio: 0.25, // 0.25 marks deducted
    sections: ['English', 'General Studies (Bengal & India)', 'Arithmetic'],
    expectedCutoffs: {
      general: 65.0,
      obc: 58.5,
      sc: 52.0,
